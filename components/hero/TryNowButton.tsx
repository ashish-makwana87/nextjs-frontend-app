...
function TryNowButton() {
  ...
  <button className="relative h-8 md:w-40 md:h-14 rounded-[50rem] border-2 border-white flex items-center gap-x-1 md:gap-x-3 bg-white pr-2 overflow-hidden group">
